...
class ZEDOptimizedRecorder:
    def __init__(self):
        ...
        self.jpeg_quality = 75  # Reduced quality for faster streaming
    ...
    def capture_loop(self):
        ...
        while self.streaming:
            if self.zed.grab(runtime_parameters) == sl.ERROR_CODE.SUCCESS:
                ...
                # YOLO detection on every frame for consistent bounding boxes
                object_count = 0
                if self.yolo_enabled:  # Every frame
                ...
                # Add overlays with ASCII characters only
                ...
                # Recording indicator - ASCII only
                if self.recording:
...
# Flask app
app = Flask(__name__)
recorder = ZEDOptimizedRecorder()

HTML_TEMPLATE = '''
<!DOCTYPE html>
<html>
<head>
    <title>ZED Optimized Recorder</title>
    <style>
        body { 
            margin: 0; 
            padding: 20px; 
...
<body>
    <div class="container">
        <div class="info">
            <h1>ZED Optimized Recorder</h1>
            <p>Smooth streaming with reduced lag and proper recording indicators</p>
        </div>
        ...
        <div class="controls">
            ...
            <button class="record-btn" onclick="startRecording()">REC Start Recording</button>
        ...
        <div class="features">
            <h4>Optimizations:</h4>
            <ul>
                <li><strong>Reduced Lag:</strong> Optimized YOLO processing and frame rates</li>
                <li><strong>ASCII Indicators:</strong> Clear [REC] text instead of unicode</li>
                <li><strong>Better Streaming:</strong> 200ms refresh rate for smoother video</li>
                <li><strong>High Quality Recording:</strong> 30fps MP4 output for demos</li>
            </ul>
        </div>
        ...
        <script>
            function startRecording() {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        document.querySelector('.record-btn').innerHTML = 'REC Recording...';
                    }
                });
            }
            ...
            function stopRecording() {
                ...
                .then(data => {
                    ...
                    document.querySelector('.record-btn').innerHTML = 'REC Start Recording';
                    if (data.session_dir) {
            ...
            function updateStatus() {
                ...
                .then(data => {
                    ...
                    if (data.recording) {
                        status.innerHTML = 'REC Recording: ' + data.session_id + '<br>' +
            ...
            // Slower refresh rate to reduce lag
...
if __name__ == '__main__':
    print("Starting ZED Optimized Recorder Server...")
